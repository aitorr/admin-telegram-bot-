...
import com.aitorr.admintelegrambot.infrastructure.jooq.indexes.FLYWAY_SCHEMA_HISTORY_S_IDX
import com.aitorr.admintelegrambot.infrastructure.jooq.keys.FLYWAY_SCHEMA_HISTORY_PK
...
open class FlywaySchemaHistory(
    ...
    public override fun getIndexes(): List<Index> = listOf(FLYWAY_SCHEMA_HISTORY_S_IDX)
    public override fun getPrimaryKey(): UniqueKey<FlywaySchemaHistoryRecord> = FLYWAY_SCHEMA_HISTORY_PK
